...
#define SCRNSHT "coreshot"
#define BROWSER "google-chrome-stable"
#define FILE_BROWSER "joshuto"
...
static Key keys[] = {
    ...
    {MODKEY, XK_Print, spawn, {.v = (const char *[]){SCRNSHT, NULL}}},
    {MODKEY, XK_b, togglebar, {0}},
    {MODKEY, XK_j, focusstack, {.i = +1}},
    {MODKEY, XK_k, focusstack, {.i = -1}},
    {MODKEY, XK_i, spawn, {.v = (const char *[]){BROWSER, NULL}}},
    {MODKEY,
     XK_f,
     spawn,
     {.v = (const char *[]){TERMINAL, "-e", FILE_BROWSER, NULL}}},
